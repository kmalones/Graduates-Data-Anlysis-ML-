# Graduates Data Analysis & Machine Learning
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/kmalones/Graduates-Data-Anlysis-ML-.git
   cd Graduates-Data-Anlysis-ML-
   ```
...
3. **Launch Jupyter Notebook:**
   ```bash
   jupyter notebook Graduates.ipynb
   ```
...
3. Run cells sequentially to load, inspect, and analyze the data.
